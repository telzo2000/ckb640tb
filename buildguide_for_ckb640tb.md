...
右側のスイッチプレート、ゲタ、PCB、ボトムケースを用意します。
...
上からM2 8mmネジを通して、ボトムケース下面で、ナットを使い固定します。
...
ネジで仮固定をします。
<br>
ロータリーエンコーダのハンダ付けしてください。
<br>
10aまたは10bを参照してください。
<br>

それが終わったら、ボトムケースに収めてください。
...
## 9b ケースの固定（choc model）

ゲタがないことと、ネジがM2 6mmに変わること以外は、9aに類似しています。
<br>


## 9c ケースの固定（first model）
